...
async fn index(State(state): State<AppState>) -> Html<String> {
    ...
    for model in models {
        let prompt = format!(r#"Generate a short, playful landing page as a COMPLETE HTML5 document.
...
- Add a small footer with the current year AND the exact text: "Generated by {model}".
